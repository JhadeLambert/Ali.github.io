(function IIFE() {
	const list = [
	{
		...
		message: "My admiration for you was hidden. My heart warms for only a moment but my mind does not allow it. Accompanied by the thoughts of maybe there is someone, maybe you're not looking for a partner, maybe she would not feel the same. My heart listened, and it resisted. We've only just met, yet why did I feel a sudden fondness?"
	},
	{
		id: 2,
		class: 'dilaw',
		...
		author: "Maki",
		title: "Dilaw",
		message: "They would banter, tease, shipping us into a relationship. \"I\'ve been through this, they would get over it,\" I said to myself. But you joined... why is that? Is it for fun? Is it for amusement? Why am I questioning this? Why am I happy about this? I thought you were only joking before but.. Am I hoping that you would feel the same? They say you are loyal, kind and honest, a full support to pursue a relationship with you. Am I really falling in love again?"
	},
	{
		id: 3,
		class: 'like',
	...
	},
	{
		...
		title: " Labyu Langga",
		message: "We confessed to each other though it was already obvious from the start. A few you went away and I began to miss you. From then I started mentally preparing. A proper courtship, planned dates, thoughtful gifts, and flowers. I was daydreaming events, imaginary moments, and a wonderful future with you along with this song that popped into my head. I suddenly notice a genuine smile and joy on my face. Let me try to love again."
	},
	{
		id: 5,
		class: 'paraluman',
		...
		author: "Adie ",
		title: "Paraluman",
		message: "I was nervous, I’d never done this before, giving someone a bouquet. I thought it would be a good impression. As I got to know you better I grew more curious. I see you as a wonderful person so how did you fall for someone like me? A dark thought lingers where the love you have for me would be temporary. But even then, I thought I should still love you the best that I can offer because that is what I think you deserve."
	},
	{
		id: 6,
		class: 'falling',
	...
	},
	{
		...
		author: "Yung Kai",
		title: "Blue",
		message: "I was happy to have found love. I was numb before, not letting a single person give me this feeling because I was afraid of getting hurt, concluding that maybe I didn't deserve such love. I was fully prepared to court you no matter how long it would take. I never thought I would hear the sweetest “yes” from you. Did not believe it for a few minutes, letting my heart sink that thought. To have you as my girlfriend. I was genuinely happy."
	},
	{
		id: 8,
		class: 'happen',
